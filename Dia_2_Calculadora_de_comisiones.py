...
print("mis numero_string son {} y {}".format(x,y))
print(f"mis numero_string son {x} y {y}")
...
print(f"{z} dividido al piso de {y} es igual a {z//y}") #dividir al piso es quitando los residuos dando un numero_string entero
